          ...
          <v-card class="elevation-18 my-4">
            ...
            <v-card-text>
              ...
              <v-alert
                ...
                class="mb-4"
                >
                <strong><a @click="form1.email='admin@example.com';form1.password='welcome123'" style="color:#fff; text-decoration: underline">Demo admin login</a>:</strong><br>
                admin@example.com / welcome123<br><br>
                
                <strong><a @click="form1.email='user@example.com';form1.password='welcome123'" style="color:#fff; text-decoration: underline">Demo user login</a>:</strong><br>
